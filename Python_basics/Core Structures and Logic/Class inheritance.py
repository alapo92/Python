...
class Coin:
    ...
    def __str__(self):  # this defines what happens when u print the object
...
class Pound(Coin):
    def __init__(self):
        data = {
            ...
            "thickness": 3.15,
            "mass": 9.5}
        super().__init__(**data)  # super accesses parent class
...
for coin in coins:
    ...
    string = "{} - Colour: {}, value:{}, diameter(mm):{}, thickness(mm):{}, " \
